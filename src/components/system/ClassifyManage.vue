    ...
    <div class="classifymanage">
      <div class="banner">
        ...
        <!--<div class="bannerright">-->
          ...
          <!--<el-dropdown>-->
            <!--<el-button class="el-dropdown-link">高级检索<i class="el-icon-arrow-down el-icon&#45;&#45;right"></i></el-button>-->
            <!--<el-dropdown-menu slot="dropdown">-->
              <!--<el-dropdown-item>按时间检索</el-dropdown-item>-->
              <!--<el-dropdown-item>按资产检索</el-dropdown-item>-->
              <!--<el-dropdown-item>按资产检索</el-dropdown-item>-->
            <!--</el-dropdown-menu>-->
          <!--</el-dropdown>-->
        <!--</div>-->
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <span class="btn" v-if="scope.row.parentId!='#'"  @click="handleLook(scope.$index, scope.row)">查看品牌</span>
              </template>
            </el-table-column>
          </el-table>
        </div></el-col>
        ...
        <el-form ref="form"  label-width="130px" style="text-align: left"  :model="form" :rules="rules">
          ...
          <el-form-item label="父级"  class="parentreg">
            <el-select v-model="form.parentId" placeholder="请选择父级">
              <el-option v-for="item in parentArr" :label="item.classifyName" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
      ...
      watch:{
        ...
        residualRatio:function(){
          ...
          if(this.residualRatio<0 || this.residualRatio>100 ){
            this.$message.error('资产使用年限在0-100之间')
