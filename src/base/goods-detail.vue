<template>
  <div class="goods-detail">
    ...
    <el-row>
      <el-col :span="3"><div class="grid-content bg-purple" style="background-color:#fff;height: 484px;color: #333;font-size: 14px;">
        <p @click="activenum=0" :class="activenum==0?'active':''" style="line-height: 30px;height: 30px;cursor: pointer;">基本信息</p>
        <p @click="processingRecordsClick"  :class="activenum==1?'active':''" style="line-height: 30px;height: 30px;cursor: pointer;">处理记录</p>
    ...
    <div class="operator" style="text-align: left">
      <el-button v-if="showedit" plain size="mini" @click="editClick">编辑</el-button>
...
<script>
export default {
  props:['uersdata','uersdatack','showedit'],
  data () {
    return {
      showBase: true,
      activenum:0,
