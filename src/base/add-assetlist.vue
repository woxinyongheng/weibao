          ...
          <table>
              <tbody>
                <tr>
                  ...
                  <td class="table-content"><el-input disabled v-model='add.id' placeholder="自动生成"></el-input></td>
                  <td class="table-title must-title">资产类别</td>
                  <td class="table-content typereg" style="position:relative">
                    <!--<el-select @visible-change="showbrandName" v-model="add.assetsTypeId" placeholder="请选择">-->
                      <!--<el-option-->
                ...
                <tr>
                  ...
                  <td class="table-content">
                    <el-select  v-model="add.brandName" placeholder="请选择">
                      <el-option
                ...
                <tr>
                  ...
                  <td class="table-content">
                    <el-select v-model="add.areaCode" placeholder="请选择">
                      <el-option
                  ...
                  <td class="table-content"><el-input v-model='add.areaName' placeholder="请输入存放位置"></el-input></td>
                </tr>
                <tr>
                ...
                <!--<tr>-->
                  ...
                  <!--<td class="table-content"><el-input type="number" v-model='add.money' placeholder="请输入折旧后金额"></el-input></td>-->
                ...
                <tr>
                  ...
                  <!--<td class="table-content img-wrapper" colspan="5">-->
                    <!--<img src="http://imgcdn.huangjinx.com/uploadFiles/goods/main/image/20180324/波浪1.jpg?imageMogr2/thumbnail/450x/interlace/0" alt="">-->
                  <!--</td>-->
                </tr>
                <tr>
...
<script>
export default {
  props:['adminList','typeList','personList','officeList','areaList','editadd','edititem','sum'],
  data () {
    return {
      brandList:[],
      showBase: true,
  ...
  mounted(){
    ...
    if(this.editadd=='edit'){
      for(var item in vm.add){
        vm.add[item] = this.edititem[item]
      }
    }
  ...
  watch:{
    canresidualRatio:function () {
      ...
      if(this.canresidualRatio>100||this.canresidualRatio==100){
        this.$message.error('残值率不得大于100,请重新输入')
