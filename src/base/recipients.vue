              ...
              <tbody>
                <tr>
                  ...
                  <td class="table-content officereg">
                    <el-select v-model="add.office" placeholder="请选择">
                      <el-option
                  ...
                  <td class="table-content">
                    <el-date-picker class="mustdate" v-model='add.receiveDate' value-format="yyyy-MM-dd" type="date" placeholder="领用日期" style="width: 100%;"></el-date-picker>
                  </td>
                </tr>
                <tr>
                  <td class="table-title must-title">所在区域</td>
                  <td class="table-content areareg">
                    <el-select v-model="add.area" placeholder="请选择">
                      <el-option
                  ...
                  <td class="table-content"><el-input placeholder="请输入内容" v-model="add.storageLocation"></el-input></td>
                  <td class="table-title"></td>
                  <td class="table-content"></td>
                </tr>
                <tr>
                  <td class="table-title">说明</td>
                  <td class="table-content" colspan="5"><el-input v-model="add.disposeExplain" placeholder="请输入内容"></el-input></td>
                </tr>
              </tbody>
            </table>
          </div>
...
<script>
export default {
  props:['lingyongList','officeList','personList','areaList','type'],
  data () {
    return {
      showBase: true,
      add:{
  ...
  methods: {
    ...
    recipentSure(){
      ...
      obj.disposeExplain=this.disposeExplain
