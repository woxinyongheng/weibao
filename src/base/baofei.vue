...
<el-date-picker type="date" class="mustdate" v-model="scrapDate" value-format="yyyy-MM-dd" placeholder="开始时间"></el-date-picker>

                  </td>
                  <td class="table-title must-title ">报废原因</td>
                  <td class="table-content"><el-input class="mustreason" v-model="scrapReason" placeholder="请输入内容"></el-input></td>
