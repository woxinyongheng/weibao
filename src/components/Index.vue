            ...
            <div class="topleftbox">
              <el-row>
                <el-col :span="12"><div class="grid-content bg-purple lineone">
                  <img src="../../static/images/assetactive.png" alt=""><span class="label">资产总数</span><span class="text">{{assetData.allMoney}}</span>
                </div></el-col>
                <el-col :span="12"><div class="grid-content bg-purple-light lineone">
                  <img src="../../static/images/assetico.png" alt=""><span class="label">资产总额</span><span class="text">{{assetData.assetCount}}</span>
                </div></el-col>
              </el-row>
              <el-row>
